...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white text-white px-6 py-2 shadow-md shadow-gray-300">
          ...
          <div className="col-sm-6">
            <div className="row h-full">
              ...
              <div className="col-sm-4 flex justify-center items-center">
               <p className="bold text-gray-400 no-underline flex justify-center items-center w-full p-0">
